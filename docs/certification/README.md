...
> This matrix preserves Sprint 1 certification coverage. For current runtime
> architecture and operations, use the [architecture](../architecture/ecommerce-agent-architecture.md)
> and [redeployment runbook](../operations/redeploy.md).

Last reviewed: 2026-07-20

The runnable Sprint 1 lab procedures are collected in
[Sprint 1 certification labs](sprint-1-labs.md).
